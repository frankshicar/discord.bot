...
class aclient(discord.Client):
  ...
  async def on_ready(self):
    ...
    if not self.synced: #check if slash commands have been synced 
      await tree.sync(guild = discord.Object('991905864162226177')) #guild specific: you can leave sync() blank to make it global. But it can take up to 24 hours, so test it in a specific guild.
      self.synced = True
    if not self.added:
      self.added = True
...
@tree.command(description='Respond hello to you.', guild=discord.Object('991905864162226177'))
async def greet(interaction: discord.Interaction):
  await interaction.response.send_message('Hello!')


@tree.command(description='Respond hello to you and mention yout user.', guild=discord.Object('991905864162226177'))
...
@tree.command(description='Respond according to the period of the day.', guild=discord.Object('991905864162226177'))
